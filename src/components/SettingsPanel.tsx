...
export default function SettingsPanel() {
    const {
        modelPath, temperature, contextWindow, systemPrompt, turboQuant,
        setModelPath, setTemperature, setContextWindow, setSystemPrompt, setTurboQuant,
    } = useModelSettings();
    ...
    return (
        <div className="flex flex-col gap-6 p-6 text-white overflow-y-auto max-h-[calc(100vh-4rem)]">
            ...
            <div className="flex flex-col gap-3">
                ...
                <label className="flex flex-col gap-1" title="Contrôle le caractère aléatoire des réponses. 0 = greedy. Défaut llama.cpp : 0.8">
                    <span className="text-sm text-slate-300">Température</span>
                    <input type="range" min={0} max={2} step={0.01} value={temperature}
                        onChange={(e) => setTemperature(Number(e.target.value))} className="w-full accent-blue-500" />
                ...
                <label className="flex flex-col gap-1" title="Taille maximale du contexte en tokens.">
                    ...
                    <input type="number" min={512} max={131072} value={contextWindow}
            ...
            <div className="flex flex-col gap-3 border-t border-white/10 pt-5 mt-2">
                ...
                <label className="flex flex-col gap-1">
                    ...
                    <p className="text-xs text-slate-500">
                        Sans clé : fonctionne avec des limites basses. Avec clé : accès illimité aux 86 000+ bibliothèques indexées.
                    </p>
                </label>
            </div>
            ...
            <div className="flex flex-col gap-3 border-t border-white/10 pt-5 mt-2">
                <div>
                    ...
                    <p className="text-xs text-slate-400 mt-1">
                        DuckDuckGo est gratuit et ne nécessite pas de clé. Les autres moteurs offrent de meilleurs résultats avec une clé API.
                    </p>
                </div>
                <label className="flex flex-col gap-1">
                ...
                <label className="flex flex-col gap-1">
                    <span className="text-sm text-slate-300">
                        Serper (Google) —{" "}
                        <a href="https://serper.dev" target="_blank" rel="noreferrer" className="text-blue-400 hover:underline">
                            serper.dev
                        </a>
                    </span>
                ...
                <label className="flex flex-col gap-1">
                    <span className="text-sm text-slate-300">
                        Tavily —{" "}
                        <a href="https://app.tavily.com" target="_blank" rel="noreferrer" className="text-blue-400 hover:underline">
                            app.tavily.com
                        </a>
                    </span>

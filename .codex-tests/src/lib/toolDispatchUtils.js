...
exports.TOOL_CATALOG = [
    ...
    {
        id: "terminal_start_interactive",
        category: "terminal",
        purpose: "démarrer une session interactive type ssh/repl",
    },
    ...
    { id: "analyze_folder", category: "fichiers", purpose: "analyser un dossier mixte avec aperçus" },
    ...
    { id: "list_folder_files", category: "fichiers", purpose: "lister les fichiers d'un dossier" },
    ...
    { id: "read_image", category: "images", purpose: "charger une image locale pour l'analyser" },
    { id: "read_image_batch", category: "images", purpose: "charger plusieurs images locales en lot" },
    { id: "list_folder_images", category: "images", purpose: "lister les images d'un dossier" },
    ...
    { id: "generate_image", category: "images", purpose: "générer une image avec Stable Diffusion" },
    { id: "list_sd_models", category: "images", purpose: "lister les modèles SD disponibles" },
    { id: "generate_3d_model", category: "images", purpose: "générer un modèle 3D GLB depuis une image (TRELLIS)" },
    {
        id: "install_trellis",
        category: "images",
        purpose: "installer TRELLIS + PyTorch (à faire une seule fois avant generate_3d_model)",
    },
